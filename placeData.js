const places = {
  NIKISZOWIEC: {
    ...
    discreption: `
# Nikoszowiec
Nikiszowiec to historyczna dzielnica Katowic.
![](https://atrakcjedzieciece.s3.amazonaws.com/uploads/attractionphoto/photo/14149/nikiszowiec_5.jpg =619x929)
Osiedle robotnicze "Nikiszowiec" dla górników kopalni "Giesche" powstało w latach 1908–1918 z inicjatywy koncernu Georg von Giesches Erben. Zaprojektowane przez architektów Emil i Georg Zillmannów, charakteryzowało się zwartej, miejskiej zabudowie z trzykondygnacyjnymi ceglanymi blokami, tworzącymi kwartały z urozmaiconymi detalami architektonicznymi.`,
  },
...
Zoo w Chrzowie mieści się na terenie Parku Śląskiego.
![](https://d-art.ppstatic.pl/kadry/k/r/1/f0/93/5ed61f198ffb7_o_original.jpg =1048x699)
...
![](https://www.travelin.pl/galeria/muzeum-slaskie-w-katowicach.jpg =1048x701)
...
![](https://atrakcjedzieciece.s3.amazonaws.com/uploads/attractionphoto/photo/15899/sciezka_lesna_dolina_trzech_stawow_katowice__14_.jpg =1048x589)
...
![](https://static.polskieszlaki.pl/zdjecia/turystyka/2022-12/1920_1080/scw-20.jpg =1048x589)
...
![](https://media-cdn.tripadvisor.com/media/photo-s/1a/6b/2c/32/czesc-kolekcji-muzeum.jpg =550x412)
...
`,
  ...
  SZYBWILSON: {
    ...
    discreption: `
# Galeria Szyb Wilson
![](https://s3.eu-central-1.amazonaws.com/pressland-cms/cache/__original__/q4/19752732-galeria-szyb-wilson-ul-oswobodzenia-1-fot-bartlomiej.jpeg =1048x698)
...
![](https://mapy.emiejsca.pl/zdjecia/katowice-teatr-slaski-41.jpg =800x600)
...
`,
  ...
  WIEZASPADOCHRONOWA: {
    ...
    discreption: `
# Wieża spadochronowa
![](https://cdn.galleries.smcloud.net/t/galleries/gf-rHsD-dBLA-QD6L_jedyna-wieza-spadochronowa-w-polsce-stoi-w-katowicach-jak-przetrwala-do-dzis-664x0-nocrop.jpg)
...
![](https://static.polityka.pl/_resource/res/path/65/5a/655a316e-f122-4942-a7cc-47c70f8b2a73_f1400x900 =1048x673)
...
`,
  ...
  JUMPCITYKatowice: {
    ...
    discreption: `
# JUMPCITY Katowice
![](https://d-pt.ppstatic.pl/k/r/1/4c/0e/57c5bfb68e15b_o.jpg?1472710915 =1048x589)
...
`,
  ...
  SPODEK: {
    ...
    discreption: `
# Katowicki Spodek
![](https://www.icohtec.org/wp-content/uploads/2018/08/Spodek.jpg =1048x785)
...
![](https://gornyslask.miemiec.eu/wp-content/uploads/2016/09/IMG_4142.jpg =1048x698)
...
![](https://www.mapofpoland.pl/zdjecia-109868/Pomnik-Powstancow-Slaskich.jpg =728x560)
...
`,
  ...
  DARLOWO: {
    name: "Darłowo",
    lat: 54.41825089838239,
    lon: 16.41016540035017,
    icon: "gold",
    locked: true,

    discreption: `
#Darłowo
![](https://cms-v2-files.idcom-jst.pl/sites/33/cms/szablony/1919/zdjecia/orign/_dsc6438.jpeg)
...
`,
  ...
  KOSCIONSWPAWEL: {
    ...
    lat: 50.25315856113778,
    lon: 19.01013129612528,
    icon: "violet",
    locked: true,

    discreption: `
# Kościół św. Piotra i Pawła
![](https://www.silesia.edu.pl/images/0/0e/Kat_PP_01.jpg =800x600)
Kościół św. Piotra i Pawła - jest to kościół, którego historia sięga XV wieku. Został wybudowany na ulicy Mikołowskiej i jest przykładem architektury typu gotyckiego. Jego wysokość również robi wrażenie, podobnie jak witraże, któe przedstawiają między innymi św. Piotra i św. Pawła, Matkę Boską Bolesną oraz Jezusa.
`,
  },

  KOSCIOLSWANNA: {
    name: "Kościół św. Anny w Katowicach",
    lat: 50.24364062915169,
    lon: 19.08367096277947,
    locked: true,
    icon: "violet",

    discreption: `
# Kościół św. Anny w Katowicach
![](https://i0.wp.com/turystycznepropozycje.pl/wp-content/uploads/2018/12/IMG_5215-scaled.jpg?w=1920&ssl=1 =414x237)
Kościół św. Anny leży w dzielnicy Janów-Nikiszowiec przy Placu Wyzwolenia w Katowicach. Został powołany 1 sierpnia 1912, można powiedzieć, że głównym celem jego budowy było zmniejszenie dystansu do najbliższego Kościoła dla dzielnicy Janów-Nikiszowiec, którzy na msze uczęszczali do wspólnoty parafialnej Najświętszego Serca Pana Jezusa w Mysłowicach, która była oddalona od dzielnicy o 4-5 km.
`,
  },

  KOSCIOLMARIACKI: {
    name: "Kościół Mariacki w Katowicach",
    lat: 50.25718141908601,
    lon: 19.030374455652666,
    icon: "violet",
    locked: true,

    discreption: `
# Kościół Mariacki w Katowicach
![](https://d-art.ppstatic.pl/kadry/k/r/fa/bb/4e9f19aa88c15_o_original.jpg =414x766)
Kościół Mariacki, nazywany też Kościołem Niepokalanego Poczęcia NMP jest kościołem budowanym w latach 1862-1870, a więc jego budowa rozpoczęła się przed nadaniem dla Katowic praw miejskich. Został wybudowany w stylu neogotyckim według projektu Alexisa Langera.
`,
  },

  KOSCIOLLUDWIG: {
    name: "Bazylika św. Ludwika Króla i Wniebowzięcia NMP w Katowicach",
    lat: 50.22692429414525,
...
![](https://i.ytimg.com/vi/4td6hGfzMzY/maxresdefault.jpg =414x232)
...
![](https://lh3.googleusercontent.com/sYCOYch8tuUInLFoFJ5so4nKnLwrUyKR7yRis7wq56xKiN1TVOn5eR4uoITbVm8Bo0_7z6Vx2rB7p-j-FbaT=s900-c =414x414)
Ta bazylika została wybudowana przy skrzyżowaniu dróg Leopolda, Markiefki i Katowickiej w dzielnicy Bogucice. Została wybudowana w drugiej połowie XIX wieku w stylu gotyckim.
`,
  },
  POMNIKPILSUCKI: {
    name: "Pomnik Józefa Piłsuckiego w Katowicach",
    lat: 50.254420199349994,
    lon: 19.025322017376993,
    icon: "grey",
    locked: true,
    discreption: `
# Pomnik Józefa Piłsuckiego w Katowicach
![](https://assets.puzzlefactory.pl/puzzle/330/524/original.jpg =414x310)
Autorem pomnika jest chorwacki rzeźbiarz Antun Augustinčić, który wyrzeźbił m.in. stojącą w ogrodach ONZ w Nowym Jorku Statuę Pokoju. Pomnik zamówiło społeczeństwo Górnego Śląska jeszcze przed II wojną światową. Posąg z brązu nie dotarł jednak do Polski w 1939. Przez wiele lat stał w muzeum rzeźbiarza najpierw w Jugosławii, a następnie w Chorwacji. W czasach komunistycznych postać marszałka była swego rodzaju tabu. Monument trafił do Katowic dopiero w 1990.`,
  },
  POMNIKWUJEK: {
    name: 'Pomnik Poległych Górników KWK "Wujek"',
    lat: 50.24382668444179,
    lon: 18.98934326334815,
    icon: "grey",
    locked: true,
    discreption: `
# Pomnik Poległych Górników KWK "Wujek"
![](https://www.globtroter.pl/zdjecia/polska/b191712_polska_pomorze_gdansk.jpg =414x443)
...
Obiekt znajduje się w ewidencji miejsc pamięci województwa śląskiego. Po lewej stronie, na murze kopalnianym, znajduje się kilkanaście pamiątkowych tablic.`,
  ...
  POMNIKWIECZOREK: {
    name: "Pomnik Józefa Wieczorka w Katowicach",
    lat: 50.244140109401854,
    lon: 19.083929389206517,
    icon: "grey",
    locked: true,
    discreption: `
# Pomnik Józefa Wieczorka w Katowicach
![](https://lh3.googleusercontent.com/proxy/q-MVSK6pnCYmIlDyDHMhUgxno1z5EQaI1WRtxHOFUb3y4Noi2SwsIjVUgQmKS6nLxB-4IjYvEc1hS-AMvs6h7o4TvOnXYQRDfq6wY6YOQkPkpxcMZ9-lpU2rdtooW8SrFZGwVQVJ2gUw4d2LPbe1jTz2Zx-APK5m7jeo3EcrPb10V7HQAi3SOkdqhA =300x400)
Pomnik Józefa Wieczorka w Katowicach – pomnik upamiętniający górnika kopalni „Giesche” – Józefa Wieczorka. Pomnik powstał w 1947 roku. Na cokole znajdowało się odlane z brązu popiersie Józefa Wieczorka, ukazujące go z lewego półprofilu. Opiekowała się nim Kopalnia Węgla Kamiennego „Wieczorek”. Popiersie w pierwszym dziesięcioleciu XXI wieku zostało skradzione. `,
  },
  POMNIKHARCEZE: {
    name: "Pomnik Harcerzy Września w Katowicach",
    lat: 50.26068688093073,
    lon: 19.021872433645658,
    icon: "grey",
    locked: true,
    discreption: `#Pomnik Harcerzy Września w Katowicach
![](https://d2exd72xrrp1s7.cloudfront.net/www/000/1k7/3n/3nb7m6u16h211r5b9sw0tjq774occ704f-uhi63659830/0?width=768&height=576&crop=true =414x310)
